...
module sha512_verify_dup_strm_128u_Pipeline_LOOP_DUP_STREAM (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (((end_nblk_strm25_full_n == 1'b0) & (e_reg_74 == 1'd0)) | ((e_reg_74 == 1'd0) & (end_nblk_strm14_full_n == 1'b0)))) | ((ap_phi_mux_e_phi_fu_77_p4 == 1'd0) & (end_nblk_strm3_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (((end_nblk_strm25_full_n == 1'b0) & (e_reg_74 == 1'd0)) | ((e_reg_74 == 1'd0) & (end_nblk_strm14_full_n == 1'b0)))) | ((ap_phi_mux_e_phi_fu_77_p4 == 1'd0) & (end_nblk_strm3_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & (((end_nblk_strm25_full_n == 1'b0) & (e_reg_74 == 1'd0)) | ((e_reg_74 == 1'd0) & (end_nblk_strm14_full_n == 1'b0)))) | ((ap_phi_mux_e_phi_fu_77_p4 == 1'd0) & (end_nblk_strm3_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_phi_mux_e_phi_fu_77_p4 == 1'd0) & (end_nblk_strm3_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((end_nblk_strm25_full_n == 1'b0) & (e_reg_74 == 1'd0)) | ((e_reg_74 == 1'd0) & (end_nblk_strm14_full_n == 1'b0)));
end
...
assign end_nblk_strm14_din = 1'd0;

assign end_nblk_strm25_din = 1'd0;

endmodule //sha512_verify_dup_strm_128u_Pipeline_LOOP_DUP_STREAM
