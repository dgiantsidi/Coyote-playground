...
module sha512_generateMsgSchedule (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        blk_strm_empty_n,
        blk_strm_read,
        end_nblk_strm132_dout,
        end_nblk_strm132_num_data_valid,
        end_nblk_strm132_fifo_cap,
        end_nblk_strm132_empty_n,
        end_nblk_strm132_read,
        w_strm34_din,
...
input  [0:0] end_nblk_strm132_dout;
input  [5:0] end_nblk_strm132_num_data_valid;
input  [5:0] end_nblk_strm132_fifo_cap;
input   end_nblk_strm132_empty_n;
output   end_nblk_strm132_read;
...
reg ap_ready;
reg blk_strm_read;
reg end_nblk_strm132_read;
reg[63:0] w_strm34_din;
reg w_strm34_write;
...
wire   [63:0] grp_generateMsgSchedule_Pipeline_LOOP_SHA512_GEN_WT16_fu_180_w_strm34_din;
wire    grp_generateMsgSchedule_Pipeline_LOOP_SHA512_GEN_WT16_fu_180_w_strm34_write;
...
wire   [63:0] grp_generateMsgSchedule_Pipeline_LOOP_SHA1_GEN_WT64_fu_218_w_strm34_din;
wire    grp_generateMsgSchedule_Pipeline_LOOP_SHA1_GEN_WT64_fu_218_w_strm34_write;
...
sha512_generateMsgSchedule_Pipeline_LOOP_SHA512_GEN_WT16 grp_generateMsgSchedule_Pipeline_LOOP_SHA512_GEN_WT16_fu_180(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sha512_generateMsgSchedule_Pipeline_LOOP_SHA1_GEN_WT64 grp_generateMsgSchedule_Pipeline_LOOP_SHA1_GEN_WT64_fu_218(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0))) & (tmp_read_fu_168_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((end_nblk_strm132_dout == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0)))) begin
...
always @ (*) begin
    if ((~((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0))) & (tmp_read_fu_168_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0))) & (end_nblk_strm132_dout == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        blk_strm_read = 1'b1;
    end else begin
        blk_strm_read = 1'b0;
    end
...
always @ (*) begin
    if ((~((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
        end_nblk_strm132_read = 1'b1;
    end else begin
        end_nblk_strm132_read = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0))) & (tmp_read_fu_168_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0))) & (end_nblk_strm132_dout == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = ((end_nblk_strm132_empty_n == 1'b0) | ((end_nblk_strm132_dout == 1'd0) & (blk_strm_empty_n == 1'b0)));
end
...
assign tmp_read_fu_168_p2 = end_nblk_strm132_dout;

endmodule //sha512_generateMsgSchedule
