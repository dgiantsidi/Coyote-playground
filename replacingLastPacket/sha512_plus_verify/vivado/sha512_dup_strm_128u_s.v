...
reg[0:0] end_nblk_strm132_din;
reg end_nblk_strm132_write;
reg[0:0] end_nblk_strm233_din;
...
wire    grp_dup_strm_128u_Pipeline_LOOP_DUP_STREAM_fu_56_end_nblk_strm31_read;
wire   [0:0] grp_dup_strm_128u_Pipeline_LOOP_DUP_STREAM_fu_56_end_nblk_strm132_din;
wire    grp_dup_strm_128u_Pipeline_LOOP_DUP_STREAM_fu_56_end_nblk_strm132_write;
wire   [0:0] grp_dup_strm_128u_Pipeline_LOOP_DUP_STREAM_fu_56_end_nblk_strm233_din;
wire    grp_dup_strm_128u_Pipeline_LOOP_DUP_STREAM_fu_56_end_nblk_strm233_write;
...
sha512_dup_strm_128u_Pipeline_LOOP_DUP_STREAM grp_dup_strm_128u_Pipeline_LOOP_DUP_STREAM_fu_56(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .end_nblk_strm31_num_data_valid(6'd0),
    .end_nblk_strm31_fifo_cap(6'd0),
    ...
    .end_nblk_strm132_num_data_valid(6'd0),
    .end_nblk_strm132_fifo_cap(6'd0),
    ...
    .end_nblk_strm233_num_data_valid(6'd0),
    .end_nblk_strm233_fifo_cap(6'd0),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((end_nblk_strm233_full_n == 1'b0) | (end_nblk_strm132_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((ap_start == 1'b0) | (end_nblk_strm31_empty_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if (((end_nblk_strm233_full_n == 1'b0) | (end_nblk_strm132_full_n == 1'b0))) begin
...
always @ (*) begin
    if ((~((end_nblk_strm233_full_n == 1'b0) | (end_nblk_strm132_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (end_nblk_strm31_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (end_nblk_strm31_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state4 = ((end_nblk_strm233_full_n == 1'b0) | (end_nblk_strm132_full_n == 1'b0));
end
...
endmodule //sha512_dup_strm_128u_s
