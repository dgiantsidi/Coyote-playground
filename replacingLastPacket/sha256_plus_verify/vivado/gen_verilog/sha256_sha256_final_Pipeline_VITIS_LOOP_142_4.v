...
module sha256_sha256_final_Pipeline_VITIS_LOOP_142_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln142_fu_1118_p2 = (ap_sig_allocacmp_i_6 + 3'd1);
...
assign icmp_ln142_fu_1112_p2 = ((ap_sig_allocacmp_i_6 == 3'd4) ? 1'b1 : 1'b0);
...
assign shl_ln1_fu_1128_p3 = {{trunc_ln143_fu_1124_p1}, {3'd0}};

assign sub_ln143_fu_1136_p2 = ($signed(5'd24) - $signed(shl_ln1_fu_1128_p3));

assign trunc_ln143_1_fu_1152_p1 = lshr_ln143_fu_1146_p2[7:0];

assign trunc_ln143_fu_1124_p1 = ap_sig_allocacmp_i_6[1:0];
...
endmodule //sha256_sha256_final_Pipeline_VITIS_LOOP_142_4
