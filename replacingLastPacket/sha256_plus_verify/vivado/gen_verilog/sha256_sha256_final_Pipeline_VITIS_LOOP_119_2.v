...
module sha256_sha256_final_Pipeline_VITIS_LOOP_119_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln120_fu_2215_p2 = (i_4_fu_422 + 64'd1);
...
assign i_8_fu_1882_p2 = (i_7_fu_418 + 32'd1);

assign icmp_ln119_fu_1873_p2 = ((tmp_fu_1863_p4 == 26'd0) ? 1'b1 : 1'b0);

assign tmp_fu_1863_p4 = {{i_7_fu_418[31:6]}};

assign trunc_ln120_fu_1888_p1 = i_4_fu_422[5:0];

assign zext_ln119_cast_fu_1526_p1 = zext_ln119;

endmodule //sha256_sha256_final_Pipeline_VITIS_LOOP_119_2
