...
module sha256_sha256_final_Pipeline_VITIS_LOOP_122_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln122_fu_1604_p2 == 1'd0)) begin
            i_6_fu_360 <= add_ln122_fu_1610_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            i_6_fu_360 <= 6'd0;
        end
    end
...
endmodule //sha256_sha256_final_Pipeline_VITIS_LOOP_122_3
