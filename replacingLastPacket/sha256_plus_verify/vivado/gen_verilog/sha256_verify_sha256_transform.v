...
wire   [7:0] tmp_s_fu_1097_p63;
wire   [7:0] tmp_31_fu_1209_p63;
wire   [7:0] tmp_32_fu_1321_p63;
...
mux_617_8_1_1_U133(
    ...
    .din60(p_read63),
    .din61(j_fu_404),
    .dout(tmp_32_fu_1321_p63)
);

sha256_verify_mux_647_32_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln37_fu_970_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        i_3_fu_416 <= add_ln39_fu_1506_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln39_fu_1474_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        i_4_fu_428 <= add_ln51_fu_1758_p2;
    end
end
...
assign add_ln39_fu_1506_p2 = (i_3_fu_416 + 7'd1);
...
assign add_ln51_fu_1758_p2 = (i_4_fu_428 + 7'd1);

assign add_ln52_1_fu_2000_p2 = (h_fu_420 + xor_ln52_1_fu_1836_p2);

assign add_ln52_2_fu_2006_p2 = (add_ln52_1_fu_2000_p2 + tmp_33_fu_1866_p66);
...
assign icmp_ln39_fu_1474_p2 = ((i_3_fu_416 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln51_fu_1752_p2 = ((i_4_fu_428 == 7'd64) ? 1'b1 : 1'b0);
...
assign m_d0 = {{{{tmp_fu_985_p63}, {tmp_s_fu_1097_p63}}, {tmp_31_fu_1209_p63}}, {tmp_32_fu_1321_p63}};
...
assign trunc_ln39_fu_1480_p1 = i_3_fu_416[5:0];
...
assign zext_ln39_fu_1470_p1 = i_3_fu_416;
...
assign zext_ln51_fu_1747_p1 = i_4_fu_428;
