...
module sha256_monProduct_512_Pipeline_VITIS_LOOP_85_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
sha256_add_514ns_514ns_514_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 514 ),
    .din1_WIDTH( 514 ),
    .dout_WIDTH( 514 ))
add_514ns_514ns_514_2_1_U745(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_174_p0),
    .din1(grp_fu_174_p1),
...
assign addA_V_fu_137_p3 = ((p_Result_5_fu_115_p3[0:0] == 1'b1) ? opA : 512'd0);
...
assign p_Result_5_fu_115_p3 = opB[zext_ln85_1_fu_111_p1];

assign ret_V_3_fu_122_p2 = (p_Result_s & p_Result_5_fu_115_p3);
...
endmodule //sha256_monProduct_512_Pipeline_VITIS_LOOP_85_1
