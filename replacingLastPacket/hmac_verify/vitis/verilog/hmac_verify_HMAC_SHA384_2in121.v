...
module hmac_verify_HMAC_SHA384_2in121 (
        opad_buffer_0,
        opad_buffer_1,
        opad_buffer_2,
        opad_buffer_3,
...
hmac_verify_preProcessingOneTripForHMAC23 preProcessingOneTripForHMAC23_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hmac_verify_generateMsgScheduleOneTrip_384u_24 generateMsgScheduleOneTrip_384u_24_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hmac_verify_fifo_w520_d32_D blk_strm_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_verify_start_for_generateMsgScheduleOneTrip_384u_24_U0 start_for_generateMsgScheduleOneTrip_384u_24_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //hmac_verify_HMAC_SHA384_2in121
