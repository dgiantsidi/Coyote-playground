...
module hmac_verify_preProcessingOneTripForHMAC23_Pipeline_VITIS_LOOP_1059_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [518:0] tmp_9_fu_537_p9;
wire   [518:0] tmp_4_cast_cast_fu_299_p1;
reg    ap_block_pp0_stage0_01001;
wire  signed [516:0] tmp_4_cast_fu_295_p1;
...
hmac_verify_my_switchEndian op_V_s_my_switchEndian_fu_251(
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            p_Val2_2_fu_156 <= tmp_4_cast_cast_fu_299_p1;
        end else if (((tmp_reg_652 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            p_Val2_2_fu_156 <= tmp_9_fu_537_p9;
        end
    end
end
...
assign tmp_4_cast_cast_fu_299_p1 = $unsigned(tmp_4_cast_fu_295_p1);

assign tmp_4_cast_fu_295_p1 = $signed(tmp_4);

assign tmp_9_fu_537_p9 = {{{{{{{{op_V_s_my_switchEndian_fu_251_ap_return}, {zext_ln414_7_fu_533_p1}}, {zext_ln414_6_fu_518_p1}}, {zext_ln414_5_fu_503_p1}}, {zext_ln414_4_fu_488_p1}}, {zext_ln414_3_fu_473_p1}}, {zext_ln414_2_fu_464_p1}}, {zext_ln414_1_fu_449_p1}};
...
endmodule //hmac_verify_preProcessingOneTripForHMAC23_Pipeline_VITIS_LOOP_1059_1
