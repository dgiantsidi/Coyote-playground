...
module hmac_injectData20_Pipeline_VITIS_LOOP_35_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
reg   [38:0] p_Val2_22_fu_108;
wire   [38:0] lenWord_V_fu_304_p3;
reg   [511:0] p_Val2_23_fu_112;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
                        p_Val2_22_fu_108[29] <= 1'b1;
            p_Val2_22_fu_108[33] <= 1'b0;
            p_Val2_22_fu_108[34] <= 1'b1;
            p_Val2_22_fu_108[38] <= 1'b0;
        end else if (((last_V_fu_268_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
                        p_Val2_22_fu_108[29] <= lenWord_V_fu_304_p3[29];
            p_Val2_22_fu_108[34 : 33] <= lenWord_V_fu_304_p3[34 : 33];
            p_Val2_22_fu_108[38] <= lenWord_V_fu_304_p3[38];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            p_Val2_23_fu_112 <= tmp_tdata_V;
        end else if (((last_V_fu_268_p3 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            p_Val2_23_fu_112 <= bbb_V_fu_254_p1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            p_Val2_s_fu_104 <= p_Result_15_fu_245_p3;
        end
    end
end
...
assign lenWord_V_3_cast_fu_201_p1 = p_Val2_22_fu_108;

assign lenWord_V_fu_304_p3 = ((last_V_fu_268_p3[0:0] == 1'b1) ? 39'd284281807112 : 39'd283744936200);

assign len_strm2_din = {{10'd264}, {lenWord_V_3_cast_fu_201_p1[29:0]}};

assign msg_key_strm1_din = {{trunc_ln674_fu_218_p1}, {p_Val2_s_fu_104[383:0]}};

assign p_Result_13_out = {{trunc_ln674_fu_218_p1}, {tmp_s_fu_235_p4}};

assign p_Result_15_fu_245_p3 = {{trunc_ln674_fu_218_p1}, {tmp_s_fu_235_p4}};
...
assign tmp_s_fu_235_p4 = {{p_Val2_23_fu_112[511:128]}};

assign tmp_tid_V_fu_258_p4 = {{input_r_TDATA[581:576]}};

assign tmp_tkeep_V_fu_276_p4 = {{input_r_TDATA[575:512]}};

assign trunc_ln674_fu_218_p1 = p_Val2_23_fu_112[127:0];

always @ (posedge ap_clk) begin
    p_Val2_22_fu_108[28:0] <= 29'b10000100001000010000100001000;
    p_Val2_22_fu_108[32:30] <= 3'b000;
    p_Val2_22_fu_108[37:35] <= 3'b000;
end

endmodule //hmac_injectData20_Pipeline_VITIS_LOOP_35_1
