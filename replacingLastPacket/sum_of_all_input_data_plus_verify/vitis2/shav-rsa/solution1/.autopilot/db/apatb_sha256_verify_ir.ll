; ModuleID = '/home/dimitra/Coyote-playground/replacingLastPacket/sum_of_all_input_data_plus_verify/vitis2/shav-rsa/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.261"(i584* align 512 %1, %"class.hls::stream<axisIntf, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<1>, 0>"(i8* align 512 %3, %"class.hls::stream<ap_uint<1>, 0>"* %2)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* nonnull %0, i584* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %2 = alloca i584
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<1>, 0>"(i8* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<1>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %2 = icmp eq i8* %0, null
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<1>, 0>"(i8* nonnull align 512 %0, %"class.hls::stream<ap_uint<1>, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<1>, 0>"(i8* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<1>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<1>, 0>.250"(%"class.hls::stream<ap_uint<1>, 0>"* %2, i8* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<1>, 0>.250"(%"class.hls::stream<ap_uint<1>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i8* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<1>, 0>.253"(%"class.hls::stream<ap_uint<1>, 0>"* nonnull %0, i8* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<1>, 0>.253"(%"class.hls::stream<ap_uint<1>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i8* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %2 = alloca i8
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.261"(i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.264"(i584* nonnull align 512 %0, %"class.hls::stream<axisIntf, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.264"(i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
