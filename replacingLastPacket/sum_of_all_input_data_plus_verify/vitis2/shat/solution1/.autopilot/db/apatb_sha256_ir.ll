; ModuleID = '/home/dimitra/Coyote-playground/replacingLastPacket/sum_of_all_input_data_plus_verify/vitis2/shat/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.100"(i584* align 512 %1, %"class.hls::stream<axisIntf, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.100"(i584* align 512 %3, %"class.hls::stream<axisIntf, 0>"* %2)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.94"(%"class.hls::stream<axisIntf, 0>"* nonnull %0, i584* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.94"(%"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  %2 = alloca i584
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.100"(i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.103"(i584* nonnull align 512 %0, %"class.hls::stream<axisIntf, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.103"(i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
