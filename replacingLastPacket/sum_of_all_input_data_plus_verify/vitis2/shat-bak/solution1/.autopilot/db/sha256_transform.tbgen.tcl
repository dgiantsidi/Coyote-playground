...
set Spec2ImplPortList { 
	...
	data { ap_memory {  { data_address0 mem_address 1 6 }  { data_ce0 mem_ce 1 1 }  { data_q0 in_data 0 8 }  { data_address1 MemPortADDR2 1 6 }  { data_ce1 MemPortCE2 1 1 }  { data_q1 in_data 0 8 } } }
}
