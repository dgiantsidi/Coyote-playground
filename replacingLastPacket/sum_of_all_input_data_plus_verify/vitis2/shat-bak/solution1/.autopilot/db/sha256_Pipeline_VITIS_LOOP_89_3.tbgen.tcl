set moduleName sha256_Pipeline_VITIS_LOOP_89_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sha256_Pipeline_VITIS_LOOP_89_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ signature int 8 regular {array 64 { 1 3 } 1 1 }  }
	{ p_Val2_1_out int 512 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "signature", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "p_Val2_1_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ p_Val2_1_out sc_out sc_lv 512 signal 1 } 
	{ p_Val2_1_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_Val2_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "p_Val2_1_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	signature { ap_memory {  { signature_address0 mem_address 1 6 }  { signature_ce0 mem_ce 1 1 }  { signature_q0 in_data 0 8 } } }
	p_Val2_1_out { ap_vld {  { p_Val2_1_out out_data 1 512 }  { p_Val2_1_out_ap_vld out_vld 1 1 } } }
}
