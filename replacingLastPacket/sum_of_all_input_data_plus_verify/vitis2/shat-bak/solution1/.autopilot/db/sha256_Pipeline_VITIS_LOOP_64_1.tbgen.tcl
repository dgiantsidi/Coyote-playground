set moduleName sha256_Pipeline_VITIS_LOOP_64_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sha256_Pipeline_VITIS_LOOP_64_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ hash_tdata_V int 512 regular  }
	{ signature int 8 regular {array 64 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "hash_tdata_V", "interface" : "wire", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ hash_tdata_V sc_in sc_lv 512 signal 0 } 
	{ signature_address0 sc_out sc_lv 6 signal 1 } 
	{ signature_ce0 sc_out sc_logic 1 signal 1 } 
	{ signature_we0 sc_out sc_logic 1 signal 1 } 
	{ signature_d0 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "hash_tdata_V", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "hash_tdata_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	hash_tdata_V { ap_none {  { hash_tdata_V in_data 0 512 } } }
	signature { ap_memory {  { signature_address0 mem_address 1 6 }  { signature_ce0 mem_ce 1 1 }  { signature_we0 mem_we 1 1 }  { signature_d0 mem_din 1 8 } } }
}
