...
architecture behav of sha256_verify is 
    ...
    signal grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start : STD_LOGIC;
    signal grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_done : STD_LOGIC;
    signal grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_idle : STD_LOGIC;
    signal grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_ready : STD_LOGIC;
    signal grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_input_r_TREADY : STD_LOGIC;
    signal grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start_reg : STD_LOGIC := '0';
    ...
    component sha256_verify_sha256_verify_Pipeline_VITIS_LOOP_108_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42 : component sha256_verify_sha256_verify_Pipeline_VITIS_LOOP_108_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_ready = ap_const_logic_1)) then 
                    grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state4, ap_CS_fsm_state5, grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_done, ap_CS_fsm_state3, regslice_both_output_r_U_apdone_blk, output_r_TREADY_int_regslice)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_done)
    begin
        if ((grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_done = ap_const_logic_0)) then 
    ...
    grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start <= grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_ap_start_reg;
    input_r_TREADY <= regslice_both_input_r_U_ack_in;

    input_r_TREADY_int_regslice_assign_proc : process(grp_sha256_verify_Pipeline_VITIS_LOOP_108_1_fu_42_input_r_TREADY, ap_CS_fsm_state3)
    begin
