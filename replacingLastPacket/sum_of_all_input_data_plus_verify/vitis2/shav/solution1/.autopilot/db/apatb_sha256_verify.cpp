...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.sha256_verify.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.sha256_verify.autotvout_input_r.dat"
...
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.sha256_verify.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.sha256_verify.autotvout_output_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_input_r "../tv/rtldatafile/rtl.sha256_verify.autotvout_input_r.dat"
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.sha256_verify.autotvout_output_r.dat"
...
extern "C" void sha256_verify_hw_stub_wrapper(volatile void *, volatile void *);

extern "C" void apatb_sha256_verify_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
long __xlx_apatb_param_output_r_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > output_r_pc_buffer;
          int i = 0;
...
char xlx_stream_elt __attribute__ ((aligned));
((char*)&xlx_stream_elt)[0*1+0] = output_r_pc_buffer[j].range(7, 0).to_int64();
((hls::stream<char>*)__xlx_apatb_param_output_r)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
...
std::vector<char> __xlx_apatb_param_output_r_stream_buf;
long __xlx_apatb_param_output_r_stream_buf_size = ((hls::stream<char>*)__xlx_apatb_param_output_r)->size();
CodeState = CALL_C_DUT;
sha256_verify_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
...
long __xlx_apatb_param_output_r_stream_buf_final_size = ((hls::stream<char>*)__xlx_apatb_param_output_r)->size() - __xlx_apatb_param_output_r_stream_buf_size;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_output_r)->empty())
    __xlx_apatb_param_output_r_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_output_r)->read());
  for (int i = 0; i < __xlx_apatb_param_output_r_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_output_r)->write(__xlx_apatb_param_output_r_stream_buf[i]);
  }
