; ModuleID = '/home/dimitra/Coyote-playground/replacingLastPacket/sum_of_all_input_data_plus_verify/vitis2/shat-rsa/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sha256_ir(%"class.hls::stream<axisIntf, 0>"* noalias nocapture nonnull dereferenceable(74) %input, %"class.hls::stream<axisIntf, 0>"* noalias nocapture nonnull dereferenceable(74) %output) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_sha256_hw(i584* %input_copy, i584* %output_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.243"(i584* align 512 %1, %"class.hls::stream<axisIntf, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.243"(i584* align 512 %3, %"class.hls::stream<axisIntf, 0>"* %2)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.237"(%"class.hls::stream<axisIntf, 0>"* nonnull %0, i584* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.237"(%"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  %2 = alloca i584
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.243"(i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.246"(i584* nonnull align 512 %0, %"class.hls::stream<axisIntf, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.246"(i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
declare void @apatb_sha256_hw(i584*, i584*)
...
define void @sha256_hw_stub_wrapper(i584*, i584*) #7 {
entry:
  %2 = alloca %"class.hls::stream<axisIntf, 0>"
  %3 = alloca %"class.hls::stream<axisIntf, 0>"
  call void @copy_out(%"class.hls::stream<axisIntf, 0>"* %2, i584* %0, %"class.hls::stream<axisIntf, 0>"* %3, i584* %1)
  call void @sha256_hw_stub(%"class.hls::stream<axisIntf, 0>"* %2, %"class.hls::stream<axisIntf, 0>"* %3)
  call void @copy_in(%"class.hls::stream<axisIntf, 0>"* %2, i584* %0, %"class.hls::stream<axisIntf, 0>"* %3, i584* %1)
  ret void
}

declare void @sha256_hw_stub(%"class.hls::stream<axisIntf, 0>"*, %"class.hls::stream<axisIntf, 0>"*)
