...
entity sha256_monProduct_512_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sha256_monProduct_512_s is 
...
attribute shreg_extract : string;
    ...
    component sha256_monProduct_512_Pipeline_MON_PRODUCT_MOD IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_monProduct_512_Pipeline_MON_PRODUCT_MOD_fu_30 : component sha256_monProduct_512_Pipeline_MON_PRODUCT_MOD
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    add_ln93_fu_58_p2 <= std_logic_vector(unsigned(trunc_ln887_fu_54_p1) + unsigned(ap_const_lv512_lc_4));
