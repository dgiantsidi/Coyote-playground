<project xmlns="com.autoesl.autopilot.project" top="sha256_verify" name="shav">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
        <SimFlow name="csim"/>
    ...
    <files xmlns="">
        ...
        <file name="vitis_hls.log" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="sha256_tb.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
