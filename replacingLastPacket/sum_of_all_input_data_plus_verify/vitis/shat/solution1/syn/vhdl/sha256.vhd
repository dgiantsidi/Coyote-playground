...
architecture behav of sha256 is 
    ...
    "sha256_sha256,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.696000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1103,HLS_SYN_LUT=603,HLS_VERSION=2022_1}";
    ...
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start : STD_LOGIC;
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_done : STD_LOGIC;
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_idle : STD_LOGIC;
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_ready : STD_LOGIC;
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_input_r_TREADY : STD_LOGIC;
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_add_i125_out : STD_LOGIC_VECTOR (511 downto 0);
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_add_i125_out_ap_vld : STD_LOGIC;
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_p_out : STD_LOGIC_VECTOR (581 downto 0);
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_p_out_ap_vld : STD_LOGIC;
    signal grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start_reg : STD_LOGIC := '0';
    ...
    signal p_loc_fu_44 : STD_LOGIC_VECTOR (581 downto 0);
    signal tmp_fu_73_p4 : STD_LOGIC_VECTOR (69 downto 0);
    signal zext_ln174_cast_fu_83_p4 : STD_LOGIC_VECTOR (582 downto 0);
    ...
    component sha256_sha256_Pipeline_VITIS_LOOP_27_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ...
        input_r_TDATA : IN STD_LOGIC_VECTOR (583 downto 0);
        input_r_TREADY : OUT STD_LOGIC;
        add_i125_out : OUT STD_LOGIC_VECTOR (511 downto 0);
        add_i125_out_ap_vld : OUT STD_LOGIC;
        p_out : OUT STD_LOGIC_VECTOR (581 downto 0);
...
begin
    grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59 : component sha256_sha256_Pipeline_VITIS_LOOP_27_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_NS_fsm_state2) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_ready = ap_const_logic_1)) then 
                    grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_p_out_ap_vld = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                p_loc_fu_44 <= grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_p_out;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state4, ap_CS_fsm_state5, grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_done, ap_CS_fsm_state3, regslice_both_output_r_U_apdone_blk, output_r_TREADY_int_regslice)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_done)
    begin
        if ((grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_done = ap_const_logic_0)) then 
    ...
    grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start <= grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_ap_start_reg;
    input_r_TREADY <= regslice_both_input_r_U_ack_in;

    input_r_TREADY_int_regslice_assign_proc : process(grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_input_r_TREADY, ap_CS_fsm_state3)
    begin
    ...
    output_r_TDATA_int_regslice <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln174_cast_fu_83_p4),584));
    ...
    tmp_fu_73_p4 <= p_loc_fu_44(581 downto 512);
    zext_ln174_cast_fu_83_p4 <= ((ap_const_lv1_1 & tmp_fu_73_p4) & grp_sha256_Pipeline_VITIS_LOOP_27_1_fu_59_add_i125_out);
end behav;
