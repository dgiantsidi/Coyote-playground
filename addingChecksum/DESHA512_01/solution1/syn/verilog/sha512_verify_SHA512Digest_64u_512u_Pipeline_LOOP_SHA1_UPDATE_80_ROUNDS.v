...
module sha512_verify_SHA512Digest_64u_512u_Pipeline_LOOP_SHA1_UPDATE_80_ROUNDS (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln232_fu_772_p2 = (w_strm6_dout + h_V_1_fu_294);
...
always @ (*) begin
    ap_block_pp0_stage1_01001 = ((icmp_ln1073_reg_1043 == 1'd0) & (w_strm6_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((icmp_ln1073_reg_1043 == 1'd0) & (w_strm6_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((icmp_ln1073_reg_1043 == 1'd0) & (w_strm6_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage1_iter0 = ((icmp_ln1073_reg_1043 == 1'd0) & (w_strm6_empty_n == 1'b0));
end
...
endmodule //sha512_verify_SHA512Digest_64u_512u_Pipeline_LOOP_SHA1_UPDATE_80_ROUNDS
