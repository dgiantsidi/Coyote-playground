...
# FIFO definition: 
set ID 122
set FifoName sha512_verify_fifo_w583_d32_D
set InstName output2_U
...
# RegSlice definition:
set ID 125
set RegSliceName sha512_verify_regslice_both
set RegSliceInstName sha512_verify_regslice_both_U
set CoreName ap_simcore_sha512_verify_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
