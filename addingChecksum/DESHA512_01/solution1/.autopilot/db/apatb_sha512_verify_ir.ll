; ModuleID = '/home/kamil/Desktop/DESHA512_01/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sha512_verify_ir(%"class.hls::stream<axisIntf, 0>"* noalias nocapture nonnull dereferenceable(74) %input, %"class.hls::stream<ap_uint<1>, 0>"* noalias nocapture nonnull dereferenceable(1) %output) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_sha512_verify_hw(i584* %input_copy, i8* %output_copy)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<1>, 0>.139"(i8* align 512 %3, %"class.hls::stream<ap_uint<1>, 0>"* %2)
  ret void
}
...
push:                                             ; preds = %empty
  ...
  %6 = call %"class.hls::stream<bool, 0>" @"_llvm.fpga.unpack.bits.s_class.hls::stream<ap_uint<1>, 0>s.i8"(i8 %5)
  %oldret2 = insertvalue %"struct.ap_int_base<1, false>" undef, %"class.hls::stream<bool, 0>" %6, 0
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.126"(%"class.hls::stream<axisIntf, 0>"* %0, i584* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<1>, 0>"(%"class.hls::stream<ap_uint<1>, 0>"* %2, i8* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.126"(%"class.hls::stream<axisIntf, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.129"(%"class.hls::stream<axisIntf, 0>"* nonnull %0, i584* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.129"(%"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %2 = alloca i584
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<1>, 0>.139"(i8* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<1>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %2 = icmp eq i8* %0, null
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<1>, 0>.142"(i8* nonnull align 512 %0, %"class.hls::stream<ap_uint<1>, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<1>, 0>.142"(i8* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<1>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
define internal i1 @"_llvm.fpga.pack.bits.i1.s_class.hls::stream<ap_uint<1>, 0>s"(%"class.hls::stream<ap_uint<1>, 0>" %A) #6 {
  ...
  %A.0.0.0.0 = extractvalue %"class.hls::stream<bool, 0>" %A.0.0.0, 0
  ret i1 %A.0.0.0.0
}

; Function Attrs: alwaysinline nounwind readnone
define internal %"class.hls::stream<bool, 0>" @"_llvm.fpga.unpack.bits.s_class.hls::stream<ap_uint<1>, 0>s.i8"(i8 %A) #6 {
  %1 = trunc i8 %A to i1
  %.0 = insertvalue %"class.hls::stream<bool, 0>" undef, i1 %1, 0
  %.01 = insertvalue %"struct.ap_int_base<1, false>" undef, %"class.hls::stream<bool, 0>" %.0, 0
  %oldret = extractvalue %"struct.ap_int_base<1, false>" %.01, 0
  ret %"class.hls::stream<bool, 0>" %oldret
}

declare void @apatb_sha512_verify_hw(i584*, i8*)
...
define void @sha512_verify_hw_stub_wrapper(i584*, i8*) #7 {
entry:
  %2 = alloca %"class.hls::stream<axisIntf, 0>"
  %3 = alloca %"class.hls::stream<ap_uint<1>, 0>"
  call void @copy_out(%"class.hls::stream<axisIntf, 0>"* %2, i584* %0, %"class.hls::stream<ap_uint<1>, 0>"* %3, i8* %1)
  call void @sha512_verify_hw_stub(%"class.hls::stream<axisIntf, 0>"* %2, %"class.hls::stream<ap_uint<1>, 0>"* %3)
  call void @copy_in(%"class.hls::stream<axisIntf, 0>"* %2, i584* %0, %"class.hls::stream<ap_uint<1>, 0>"* %3, i8* %1)
  ret void
}

declare void @sha512_verify_hw_stub(%"class.hls::stream<axisIntf, 0>"*, %"class.hls::stream<ap_uint<1>, 0>"*)
