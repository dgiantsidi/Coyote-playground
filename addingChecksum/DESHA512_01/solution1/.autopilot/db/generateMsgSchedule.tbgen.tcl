...
set C_modelArgList {
	...
	{ end_nblk_strm14 int 1 regular {fifo 0 volatile }  }
	{ w_strm6 int 64 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "blk_strm", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY"} , 
 	{ "Name" : "end_nblk_strm14", "interface" : "fifo", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ end_nblk_strm14_dout sc_in sc_lv 1 signal 1 } 
	{ end_nblk_strm14_num_data_valid sc_in sc_lv 6 signal 1 } 
	{ end_nblk_strm14_fifo_cap sc_in sc_lv 6 signal 1 } 
	{ end_nblk_strm14_empty_n sc_in sc_logic 1 signal 1 } 
	{ end_nblk_strm14_read sc_out sc_logic 1 signal 1 } 
	{ w_strm6_din sc_out sc_lv 64 signal 2 } 
	{ w_strm6_num_data_valid sc_in sc_lv 6 signal 2 } 
	{ w_strm6_fifo_cap sc_in sc_lv 6 signal 2 } 
	{ w_strm6_full_n sc_in sc_logic 1 signal 2 } 
	{ w_strm6_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "end_nblk_strm14_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "end_nblk_strm14", "role": "dout" }} , 
 	...
 	{ "name": "end_nblk_strm14_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "end_nblk_strm14", "role": "empty_n" }} , 
 	{ "name": "end_nblk_strm14_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "end_nblk_strm14", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4"],
		...
		"Port" : [
			...
			{"Name" : "end_nblk_strm14", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "end_nblk_strm14_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "w_strm6", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_generateMsgSchedule_Pipeline_LOOP_SHA1_GEN_WT64_fu_218", "Port" : "w_strm6", "Inst_start_state" : "6", "Inst_end_state" : "7"},
					{"ID" : "1", "SubInstance" : "grp_generateMsgSchedule_Pipeline_LOOP_SHA512_GEN_WT16_fu_180", "Port" : "w_strm6", "Inst_start_state" : "3", "Inst_end_state" : "4"}]}],
		"Loop" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_generateMsgSchedule_Pipeline_LOOP_SHA512_GEN_WT16_fu_180.mux_165_64_1_1_U30", "Parent" : "1"},
...
set Spec2ImplPortList { 
	...
	end_nblk_strm14 { ap_fifo {  { end_nblk_strm14_dout fifo_port_we 0 1 }  { end_nblk_strm14_num_data_valid fifo_status_num_data_valid 0 6 }  { end_nblk_strm14_fifo_cap fifo_update 0 6 }  { end_nblk_strm14_empty_n fifo_status 0 1 }  { end_nblk_strm14_read fifo_data 1 1 } } }
