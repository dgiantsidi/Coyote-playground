; ModuleID = '/home/kamil/Desktop/SHA512_01/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sha512_ir(%"class.hls::stream<axisIntf, 0>"* noalias nocapture nonnull dereferenceable(74) %input, %"class.hls::stream<axisIntf, 0>"* noalias nocapture nonnull dereferenceable(74) %output) local_unnamed_addr #1 {
entry:
  %input_copy = alloca i584, align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(i584* %input_copy, i32 0) ]
  %output_copy = alloca i584, align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(i584* %output_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<axisIntf, 0>"* nonnull %input, i584* nonnull align 512 %input_copy, %"class.hls::stream<axisIntf, 0>"* nonnull %output, i584* nonnull align 512 %output_copy)
  call void @apatb_sha512_hw(i584* %input_copy, i584* %output_copy)
  call void @copy_back(%"class.hls::stream<axisIntf, 0>"* %input, i584* %input_copy, %"class.hls::stream<axisIntf, 0>"* %output, i584* %output_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<axisIntf, 0>"* noalias, i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias, i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.71"(i584* align 512 %1, %"class.hls::stream<axisIntf, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.71"(i584* align 512 %3, %"class.hls::stream<axisIntf, 0>"* %2)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<axisIntf, 0>"* noalias, i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias, i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* %0, i584* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* %2, i584* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* noalias "fpga.caller.interfaces"="layout_transformed", i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.64"(%"class.hls::stream<axisIntf, 0>"* nonnull %0, i584* nonnull align 512 %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.64"(%"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed", i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  %2 = alloca i584
...
define internal <{ %"struct.ap_uint<512>", %"struct.ap_uint<64>", %"struct.ap_uint<6>", %"struct.ap_uint<1>" }> @"_llvm.fpga.unpack.bits.s_class.hls::stream<axisIntf, 0>s.i584"(i584 %A) #6 {
  ...
  %.010 = insertvalue %"class.hls::stream<bool, 0>" undef, i1 %8, 0
  %.011 = insertvalue %"struct.ap_int_base<1, false>" undef, %"class.hls::stream<bool, 0>" %.010, 0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>.71"(i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.74"(i584* nonnull align 512 %0, %"class.hls::stream<axisIntf, 0>"* nonnull %1)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<axisIntf, 0>.74"(i584* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
define internal i583 @"_llvm.fpga.pack.bits.i583.s_class.hls::stream<axisIntf, 0>s"(%"class.hls::stream<axisIntf, 0>" %A) #6 {
  ...
  %A.0.3.0.0.0 = extractvalue %"class.hls::stream<bool, 0>" %A.0.3.0.0, 0
...
declare void @apatb_sha512_hw(i584*, i584*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<axisIntf, 0>"* noalias, i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<axisIntf, 0>"* noalias, i584* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* %0, i584* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<axisIntf, 0>"(%"class.hls::stream<axisIntf, 0>"* %2, i584* align 512 %3)
  ret void
...
define void @sha512_hw_stub_wrapper(i584*, i584*) #7 {
entry:
  %2 = alloca %"class.hls::stream<axisIntf, 0>"
  %3 = alloca %"class.hls::stream<axisIntf, 0>"
  call void @copy_out(%"class.hls::stream<axisIntf, 0>"* %2, i584* %0, %"class.hls::stream<axisIntf, 0>"* %3, i584* %1)
  call void @sha512_hw_stub(%"class.hls::stream<axisIntf, 0>"* %2, %"class.hls::stream<axisIntf, 0>"* %3)
  call void @copy_in(%"class.hls::stream<axisIntf, 0>"* %2, i584* %0, %"class.hls::stream<axisIntf, 0>"* %3, i584* %1)
  ret void
}

declare void @sha512_hw_stub(%"class.hls::stream<axisIntf, 0>"*, %"class.hls::stream<axisIntf, 0>"*)
