...
set C_modelArgList {
	...
	{ end_nblk_strm31 int 1 regular {fifo 1 volatile }  }
	{ tkeep_strm35 int 64 regular {fifo 1 volatile }  }
	{ tid_strm36 int 6 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "axis", "bitwidth" : 584, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "end_nblk_strm31", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "tkeep_strm35", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "tid_strm36", "interface" : "fifo", "bitwidth" : 6, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ end_nblk_strm31_din sc_out sc_lv 1 signal 2 } 
	{ end_nblk_strm31_num_data_valid sc_in sc_lv 6 signal 2 } 
	{ end_nblk_strm31_fifo_cap sc_in sc_lv 6 signal 2 } 
	{ end_nblk_strm31_full_n sc_in sc_logic 1 signal 2 } 
	{ end_nblk_strm31_write sc_out sc_logic 1 signal 2 } 
	{ tkeep_strm35_din sc_out sc_lv 64 signal 3 } 
	{ tkeep_strm35_num_data_valid sc_in sc_lv 6 signal 3 } 
	{ tkeep_strm35_fifo_cap sc_in sc_lv 6 signal 3 } 
	{ tkeep_strm35_full_n sc_in sc_logic 1 signal 3 } 
	{ tkeep_strm35_write sc_out sc_logic 1 signal 3 } 
	{ tid_strm36_din sc_out sc_lv 6 signal 4 } 
	{ tid_strm36_num_data_valid sc_in sc_lv 6 signal 4 } 
	{ tid_strm36_fifo_cap sc_in sc_lv 6 signal 4 } 
	{ tid_strm36_full_n sc_in sc_logic 1 signal 4 } 
	{ tid_strm36_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "end_nblk_strm31_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "end_nblk_strm31", "role": "din" }} , 
 	...
 	{ "name": "end_nblk_strm31_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "end_nblk_strm31", "role": "full_n" }} , 
 	{ "name": "end_nblk_strm31_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "end_nblk_strm31", "role": "write" }} , 
 	{ "name": "tkeep_strm35_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "tkeep_strm35", "role": "din" }} , 
 	...
 	{ "name": "tkeep_strm35_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tkeep_strm35", "role": "full_n" }} , 
 	{ "name": "tkeep_strm35_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tkeep_strm35", "role": "write" }} , 
 	{ "name": "tid_strm36_din", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "tid_strm36", "role": "din" }} , 
 	...
 	{ "name": "tid_strm36_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tid_strm36", "role": "full_n" }} , 
 	{ "name": "tid_strm36_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tid_strm36", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "end_nblk_strm31", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "end_nblk_strm31_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "tkeep_strm35", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "tkeep_strm35_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "tid_strm36", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_preProcessing_Pipeline_LOOP_COPY_TAIL_AND_PAD_1_fu_267", "Parent" : "0", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_preProcessing_Pipeline_LOOP_COPY_TAIL_AND_PAD_1_fu_267.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"}]}
...
set Spec2ImplPortList { 
	...
	end_nblk_strm31 { ap_fifo {  { end_nblk_strm31_din fifo_port_we 1 1 }  { end_nblk_strm31_num_data_valid fifo_status_num_data_valid 0 6 }  { end_nblk_strm31_fifo_cap fifo_update 0 6 }  { end_nblk_strm31_full_n fifo_status 0 1 }  { end_nblk_strm31_write fifo_data 1 1 } } }
	tkeep_strm35 { ap_fifo {  { tkeep_strm35_din fifo_port_we 1 64 }  { tkeep_strm35_num_data_valid fifo_status_num_data_valid 0 6 }  { tkeep_strm35_fifo_cap fifo_update 0 6 }  { tkeep_strm35_full_n fifo_status 0 1 }  { tkeep_strm35_write fifo_data 1 1 } } }
	tid_strm36 { ap_fifo {  { tid_strm36_din fifo_port_we 1 6 }  { tid_strm36_num_data_valid fifo_status_num_data_valid 0 6 }  { tid_strm36_fifo_cap fifo_update 0 6 }  { tid_strm36_full_n fifo_status 0 1 }  { tid_strm36_write fifo_data 1 1 } } }
}
