...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { end_nblk_strm132_dout { I 1 vector } end_nblk_strm132_num_data_valid { I 6 vector } end_nblk_strm132_fifo_cap { I 6 vector } end_nblk_strm132_empty_n { I 1 bit } end_nblk_strm132_read { O 1 bit } } \
} "
}
