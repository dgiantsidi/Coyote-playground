...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.sha512.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.sha512.autotvout_input_r.dat"
...
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.sha512.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.sha512.autotvout_output_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_input_r "../tv/rtldatafile/rtl.sha512.autotvout_input_r.dat"
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.sha512.autotvout_output_r.dat"
...
struct __cosim_s73__ { char data[128]; };
extern "C" void sha512_hw_stub_wrapper(volatile void *, volatile void *);

extern "C" void apatb_sha512_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
long __xlx_apatb_param_input_r_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_input_r_stream_buf_final_size; ++i)((hls::stream<__cosim_s73__>*)__xlx_apatb_param_input_r)->read();
long __xlx_apatb_param_output_r_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<584> > output_r_pc_buffer;
          int i = 0;
...
__cosim_s73__ xlx_stream_elt __attribute__ ((aligned));
((long long*)&xlx_stream_elt)[0*16+0] = output_r_pc_buffer[j].range(63,0).to_int64();
((long long*)&xlx_stream_elt)[0*16+1] = output_r_pc_buffer[j].range(127,64).to_int64();
((long long*)&xlx_stream_elt)[0*16+2] = output_r_pc_buffer[j].range(191,128).to_int64();
((long long*)&xlx_stream_elt)[0*16+3] = output_r_pc_buffer[j].range(255,192).to_int64();
((long long*)&xlx_stream_elt)[0*16+4] = output_r_pc_buffer[j].range(319,256).to_int64();
((long long*)&xlx_stream_elt)[0*16+5] = output_r_pc_buffer[j].range(383,320).to_int64();
((long long*)&xlx_stream_elt)[0*16+6] = output_r_pc_buffer[j].range(447,384).to_int64();
((long long*)&xlx_stream_elt)[0*16+7] = output_r_pc_buffer[j].range(511,448).to_int64();
((long long*)&xlx_stream_elt)[0*16+8] = output_r_pc_buffer[j].range(575,512).to_int64();
((long long*)&xlx_stream_elt)[0*16+9] = output_r_pc_buffer[j].range(583,576).to_int64();
((hls::stream<__cosim_s73__>*)__xlx_apatb_param_output_r)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
...
std::vector<__cosim_s73__> __xlx_apatb_param_input_r_stream_buf;
{
  while (!((hls::stream<__cosim_s73__>*)__xlx_apatb_param_input_r)->empty())
    __xlx_apatb_param_input_r_stream_buf.push_back(((hls::stream<__cosim_s73__>*)__xlx_apatb_param_input_r)->read());
  for (int i = 0; i < __xlx_apatb_param_input_r_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s73__>*)__xlx_apatb_param_input_r)->write(__xlx_apatb_param_input_r_stream_buf[i]);
  }
long __xlx_apatb_param_input_r_stream_buf_size = ((hls::stream<__cosim_s73__>*)__xlx_apatb_param_input_r)->size();
std::vector<__cosim_s73__> __xlx_apatb_param_output_r_stream_buf;
long __xlx_apatb_param_output_r_stream_buf_size = ((hls::stream<__cosim_s73__>*)__xlx_apatb_param_output_r)->size();
CodeState = CALL_C_DUT;
sha512_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_input_r_stream_buf_final_size = __xlx_apatb_param_input_r_stream_buf_size - ((hls::stream<__cosim_s73__>*)__xlx_apatb_param_input_r)->size();
...
std::string s(formatData(pos, 584));
...
long __xlx_apatb_param_output_r_stream_buf_final_size = ((hls::stream<__cosim_s73__>*)__xlx_apatb_param_output_r)->size() - __xlx_apatb_param_output_r_stream_buf_size;
{
  while (!((hls::stream<__cosim_s73__>*)__xlx_apatb_param_output_r)->empty())
    __xlx_apatb_param_output_r_stream_buf.push_back(((hls::stream<__cosim_s73__>*)__xlx_apatb_param_output_r)->read());
  for (int i = 0; i < __xlx_apatb_param_output_r_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s73__>*)__xlx_apatb_param_output_r)->write(__xlx_apatb_param_output_r_stream_buf[i]);
  }
